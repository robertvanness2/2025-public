...
def plan(quiet):
    ...
    start_pose = constants.DS_LEFT_START_POSE
    qp = QuikPlan(
        field,
        robot,
        start_pose,
    ...
    waypoint2 = constants.START_BACK_LEFT_APPROACH_POSE
    qp.add_waypoint(waypoint2, 50, end_constraints=[PoseConstraint(waypoint2)])
