...
/**
 * A map that allows for interpolation between values associated with double keys. This class uses a
 * TreeMap to store the key-value pairs and provides methods to set, clear, and retrieve values with
 * interpolation.
 *
 * @param <T> The type of the values to be interpolated.
 */
