...
public class FrontOnlyAutoRightStart implements AutoCommand {
  private final QuikPlanSwervePartialTrajectoryReader topStartFront =
      new QuikPlanSwervePartialTrajectoryReader("left_start_to_front.csv", true);
  private final QuikPlanSwervePartialTrajectoryReader frontToRightSource =
      new QuikPlanSwervePartialTrajectoryReader("front_to_right_source.csv", true);

  private final Command m_command;

  public FrontOnlyAutoRightStart(
