...
public class AutoFourPieceRightEndFront implements AutoCommand {
  ...
  private final QuikPlanSwervePartialTrajectoryReader frontLeftToSourceRetBL =
      new QuikPlanSwervePartialTrajectoryReader("FL_S_RET_F.csv", true);

  private final Command m_command;

  public AutoFourPieceRightEndFront(
