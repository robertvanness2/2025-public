...
/**
 * Utility class for performing various mathematical operations related to camera coordinates and
 * transformations. This class provides methods to convert between Cartesian coordinates and
 * bearing/elevation angles in both pinhole and spherical camera models, as well as methods to
 * convert between pixel coordinates and yaw/pitch angles.
 */
