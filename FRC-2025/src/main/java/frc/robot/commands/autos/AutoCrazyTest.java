...
public class AutoCrazyTest implements AutoCommand {
  private final QuikPlanSwervePartialTrajectoryReader m_traj =
      new QuikPlanSwervePartialTrajectoryReader("crazy_test.csv");

  private final Command m_command;

  public AutoCrazyTest(final SwerveSubsystem swerve) {
